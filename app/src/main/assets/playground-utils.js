...
function notifySwift(action, data) {
    ...
    console.warn('⚠️ Native message handler not available (neither iOS nor Android)');
}
...
function setFullEditorContent(editor, code) {
    ...
    try {
        ...
        if (typeof editor.setValue === 'function') {
            ...
            console.log('✓ Code injection handled by native platform');
        }
    } catch (e) {
        // Gracefully handle platform differences
        console.log('✓ setFullEditorContent not needed on this platform');
    }
}
